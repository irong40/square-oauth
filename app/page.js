export default function Home() {
  ...
  const scopes = 'ITEMS_READ+ITEMS_WRITE+ORDERS_READ+ORDERS_WRITE+CUSTOMERS_READ+MERCHANT_PROFILE_READ+PAYMENTS_READ';
  const authUrl = `https://connect.squareup.com/oauth2/authorize?client_id=${clientId}&scope=${scopes}&session=false`;
